...
#     return render(request,'contactus.html',{'Contact':Contact,'about':True})
...
def contactus(request):
    if request.method == 'POST':
        ...
        if firstname and lastname and message and email and phone:
            try:
                send_mail("This is Subject", message,settings.EMAIL_HOST_USER,['chandruhom@gmail.com'])
...
#         if firstname and lastname and message and email and phone:
#             try:
#                 send_mail(firstname, lastname,phone,email, message, settings.EMAIL_HOST_USER)
#                 context['result'] = "Email Sent Successfully",
#             except Exception as e:
#                 context['result'] = f'Error sending email: {e}'
#         else:
#             context['result'] = 'All field are required'
